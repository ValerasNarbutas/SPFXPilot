...
const _items = [
  ...
  {
    key: 'd',
    name: 'IPM portfolio depedencies',
    color: 'blue'
  },
  {
    key: 'e',
    name: 'GIS dependencies',
    color: 'blue'
  }
];

export default class DetailsListGroupedExample extends BaseComponent<
  {},
  {
    items: {}[];
